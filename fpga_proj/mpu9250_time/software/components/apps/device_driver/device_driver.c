...
float deltat = 0.0, sum = 0.0;        // integration interval for both filter schemes
...
int main(void)
{
	uint32_t start = 0;
		...
		{  
				...
				MahonyQuaternionUpdate(ax, ay, az, gx*M_PI/180.0, gy*M_PI/180.0, gz*M_PI/180.0, my, mx, mz);
