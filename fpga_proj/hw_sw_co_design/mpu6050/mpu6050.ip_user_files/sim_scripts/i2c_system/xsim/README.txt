...
#
# Generated by export_simulation on Tue Jul 31 01:10:28 KST 2018
#
################################################################################
...
switch to the './i2c_system.sh' script.

./i2c_system.sh -reset_run
...
./i2c_system.sh -noclean_files

For more information on the script, please type './i2c_system.sh -help'.
