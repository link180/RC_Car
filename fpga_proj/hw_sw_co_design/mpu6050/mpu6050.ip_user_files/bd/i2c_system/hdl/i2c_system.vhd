...
--Date        : Tue Jul 31 01:10:27 2018
--Host        : sdr-Samsung-DeskTop-System running 64-bit Ubuntu 16.04.3 LTS
--Command     : generate_target i2c_system.bd
--Design      : i2c_system
...
entity i2c_system is
  ...
  attribute CORE_GENERATION_INFO of i2c_system : entity is "i2c_system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=i2c_system,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of i2c_system : entity is "i2c_system.hwdef";
end i2c_system;

architecture STRUCTURE of i2c_system is
  component i2c_system_processing_system7_0_0 is
  port (
  ...
  end component i2c_system_processing_system7_0_0;
...
processing_system7_0: component i2c_system_processing_system7_0_0
     port map (
